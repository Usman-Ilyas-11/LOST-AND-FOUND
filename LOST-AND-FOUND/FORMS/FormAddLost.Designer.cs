...
namespace LOST_AND_FOUND
{
    partial class FormAddLost
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtLoc = CreateTextBox("Location Lost", 30, 200, SoftIvory);
            txtDate = CreateTextBox("Date (YYYY-MM-DD)", 30, 250, SoftIvory);
            txtDate.Text = DateTime.Now.ToString("yyyy-MM-dd");
            txtPerson = CreateTextBox("Your Name", 30, 300, SoftIvory);
