...
namespace LOST_AND_FOUND
{
    partial class FormViewLost
    {
        ...
        private void InitializeComponent()
        {
            ...
            list.Columns.Add("Person", 150, HorizontalAlignment.Left);
        ...
        private void List_DoubleClick(object sender, System.EventArgs e)
        {
            ...
            if (it != null)
            {
                var dlg = new FormShowItem(it.ItemName, it.Description, it.LocationLost, it.LostDate, it.PersonName, it.Contact, it.Image);
                dlg.ShowDialog();
            }
        }
    }
